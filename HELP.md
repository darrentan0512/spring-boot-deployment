...
* The original package name 'com.example.company.deployment.spring-boot-deployment' is invalid and this project uses 'com.example.company.deployment.spring_boot_deployment' instead.
